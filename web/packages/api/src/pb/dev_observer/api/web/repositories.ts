...
export interface GetAuthenticatedRepoRequest {
  repoFullName: string;
  provider: GitProvider;
}

export interface GetAuthenticatedRepoResponse {
...
function createBaseGetAuthenticatedRepoRequest(): GetAuthenticatedRepoRequest {
  return { repoFullName: "", provider: 0 };
}

export const GetAuthenticatedRepoRequest: MessageFns<GetAuthenticatedRepoRequest> = {
  encode(message: GetAuthenticatedRepoRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetAuthenticatedRepoRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetAuthenticatedRepoRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetAuthenticatedRepoRequest {
    return {
  ...
  toJSON(message: GetAuthenticatedRepoRequest): unknown {
    const obj: any = {};
    if (message.repoFullName !== "") {
  ...
  create(base?: DeepPartial<GetAuthenticatedRepoRequest>): GetAuthenticatedRepoRequest {
    return GetAuthenticatedRepoRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetAuthenticatedRepoRequest>): GetAuthenticatedRepoRequest {
    const message = createBaseGetAuthenticatedRepoRequest();
...
function createBaseGetAuthenticatedRepoResponse(): GetAuthenticatedRepoResponse {
  return { authenticatedUrl: "" };
}

export const GetAuthenticatedRepoResponse: MessageFns<GetAuthenticatedRepoResponse> = {
  encode(message: GetAuthenticatedRepoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.authenticatedUrl !== "") {
      writer.uint32(10).string(message.authenticatedUrl);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetAuthenticatedRepoResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.authenticatedUrl = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GetAuthenticatedRepoResponse {
    return { authenticatedUrl: isSet(object.authenticatedUrl) ? gt.String(object.authenticatedUrl) : "" };
  },

  toJSON(message: GetAuthenticatedRepoResponse): unknown {
    const obj: any = {};
    if (message.authenticatedUrl !== "") {
      obj.authenticatedUrl = message.authenticatedUrl;
    }
    return obj;
  },

  create(base?: DeepPartial<GetAuthenticatedRepoResponse>): GetAuthenticatedRepoResponse {
    return GetAuthenticatedRepoResponse.fromPartial(base ?? {});
  },
