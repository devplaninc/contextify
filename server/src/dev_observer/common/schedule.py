...
from dev_observer.api.types.schedule_pb2 import Schedule, DayOfWeek, Frequency
...
def _create_target_datetime(target_date: datetime.date, time_config) -> datetime.datetime:
    ...
    target_datetime = datetime.datetime(
        ...
        second=time_of_day.seconds,
        microsecond=time_of_day.nanos // 1000,  # Convert nanoseconds to microseconds
        tzinfo=tz
    )
