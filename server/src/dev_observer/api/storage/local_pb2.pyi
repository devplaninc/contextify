...
class LocalStorageData(_message.Message):
    ...
    def __init__(self, git_repos: _Optional[_Iterable[_Union[_repo_pb2.GitRepository, _Mapping]]] = ..., processing_items: _Optional[_Iterable[_Union[_processing_pb2.ProcessingItem, _Mapping]]] = ..., global_config: _Optional[_Union[_config_pb2.GlobalConfig, _Mapping]] = ..., web_sites: _Optional[_Iterable[_Union[_sites_pb2.WebSite, _Mapping]]] = ..., processing_results: _Optional[_Iterable[_Union[_processing_pb2.ProcessingItemResult, _Mapping]]] = ..., tokens: _Optional[_Iterable[_Union[_tokens_pb2.AuthToken, _Mapping]]] = ...) -> None: ...
