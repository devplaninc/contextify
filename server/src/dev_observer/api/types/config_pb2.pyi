...
class RepoAnalysisConfig(_message.Message):
    ...
    class Research(_message.Message):
        __slots__ = ("max_repo_size_mb", "max_iterations", "general_prefix", "analyzers", "report_chunk_size", "max_tool_content_tokens", "history_limits")
        MAX_REPO_SIZE_MB_FIELD_NUMBER: _ClassVar[int]
        ...
        HISTORY_LIMITS_FIELD_NUMBER: _ClassVar[int]
        max_repo_size_mb: int
        max_iterations: int
        general_prefix: str
        ...
        history_limits: RepoAnalysisConfig.ResearchHistoryLimits
        def __init__(self, max_repo_size_mb: _Optional[int] = ..., max_iterations: _Optional[int] = ..., general_prefix: _Optional[str] = ..., analyzers: _Optional[_Iterable[_Union[_observations_pb2.Analyzer, _Mapping]]] = ..., report_chunk_size: _Optional[int] = ..., max_tool_content_tokens: _Optional[int] = ..., history_limits: _Optional[_Union[RepoAnalysisConfig.ResearchHistoryLimits, _Mapping]] = ...) -> None: ...
    class ResearchHistoryLimits(_message.Message):
        __slots__ = ("plan", "summarize")
        PLAN_FIELD_NUMBER: _ClassVar[int]
        SUMMARIZE_FIELD_NUMBER: _ClassVar[int]
        plan: int
        summarize: int
        def __init__(self, plan: _Optional[int] = ..., summarize: _Optional[int] = ...) -> None: ...
